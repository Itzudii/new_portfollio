...
export class Dog {
    constructor(land) {
      ...
      this.state = "sit";
      this.w;
      // this.cltrscreen.canvas.addEventListener("mouseenter", () => {
      //   this.standby = false;
      // })
      // this.cltrscreen.canvas.addEventListener("mouseleave", () => {
      //   this.standby = true;
      // })
      // this.cltrscreen.canvas.addEventListener("mousemove", (e) => {
      //   this.x = e.clientX;
      // })
    ...
    async _addimg(key, data) {
      ...
      for (let i = 0; i < data[key].length; i++) {
        ...
        let invimge = await jsnake.image.scale(img, [-1, 1]);
